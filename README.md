...
![](https://img.shields.io/github/v/release/hibert125-coder/x-ui.svg)
![](https://img.shields.io/docker/pulls/hibert125-coder/x-ui.svg)
...
[![Downloads](https://img.shields.io/github/downloads/hibert125-coder/x-ui/total.svg)](https://img.shields.io/github/downloads/hibert125-coder/x-ui/total.svg)
...
[!["Buy Me A Coffee"](https://www.buymeacoffee.com/assets/img/custom_images/orange_img.png)](https://www.buymeacoffee.com/hibert125-coder)

<a href="https://nowpayments.io/donation/hibert125-coder" target="_blank" rel="noreferrer noopener">
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/hibert125-coder/x-ui/master/install.sh)
```
...
```sh
VERSION=1.8.0 && bash <(curl -Ls "https://raw.githubusercontent.com/hibert125-coder/x-ui/$VERSION/install.sh") $VERSION
```
...
[![Stargazers over time](https://starchart.cc/hibert125-coder/x-ui.svg)](https://starchart.cc/hibert125-coder/x-ui)
